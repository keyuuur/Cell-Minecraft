...
- Run 4 delivery checkpoint: `1adb34a79f55665e74d8902f6904492adec85412` (`docs: record Run 4 report delivery`) is pushed and remains the verified upstream base for the local Visual Pass 3 candidate. The candidate passed its complete local gate on 2026-07-16 and is ready for an explicit-file commit; its exact SHA must be recorded immediately after that commit and before protected Preview testing.
